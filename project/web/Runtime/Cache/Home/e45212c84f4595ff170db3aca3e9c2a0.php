...
$(document).ready(function(){
  ...
  <div class="container" style="margin-top:10px;">
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <?php if(is_array($jobs)): foreach($jobs as $k=>$vo): ?><div class="row" style="margin-top:10px;">
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img src="holder.js/242x200" alt="...">
            <div class="caption">
              <h3><?php echo ($vo["work"]); ?></h3>
              <p><?php echo ($vo["job_intro"]); ?></p>
              <p>
              <a href="<?php echo U('Home/Job/intro');?>" class="btn btn-primary" role="button">岗位详情</a>
              <a href="<?php echo U('Home/Job/sent');?>" class="btn btn-default" role="button">填写简历</a></p>
            </div>
          </div>
        </div>
