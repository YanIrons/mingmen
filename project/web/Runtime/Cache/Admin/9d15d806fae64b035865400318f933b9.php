...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">商品评论信息修改</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
               <div class="row">
                   <div class="col-lg-6">
                       <form role="form" action="<?php echo U('Admin/Goodscomment/update');?>" method="post" enctype="multipart/form-data">
                           <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                           <div class="form-group">
                               <label>用户ID</label>
                               <input name="user_id" value="<?php echo ($info["user_id"]); ?>" placeholder="请输入要修改的用户ID" class="form-control">
                           </div>

                           <div class="form-group">
                               <label>商品ID</label>
                               <input name="goods_id" value="<?php echo ($info["goods_id"]); ?>" placeholder="请输入要修改的标题名" class="form-control">
                           </div>
                           ...
                           <div class="form-group">
                               <label>商品名</label>
                               <input name="gname" value="<?php echo ($info["gname"]); ?>" placeholder="请输入要修改的商品名名" class="form-control">
                           </div>

                           <div class="form-group">
                               <label>评论信息介绍栏</label>
                               <script id="editor" name="commsg" type="text/plain" style="width:auto;height:500px;"><?php echo ($resg); ?></script>
                           </div>
