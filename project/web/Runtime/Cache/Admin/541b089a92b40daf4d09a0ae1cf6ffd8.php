                    ...
                    <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                      ...
                      <tbody>
                        <?php if(is_array($fashions)): foreach($fashions as $k=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td class="ffmsg"><?php  echo 'htmlspecialchars_decode{'."$vo.fmsg".'}';?></td>

                          <!--   <td class="ffmsg"><textarea></textarea></td>  -->
                            <td class="center">
                              <button class="btn btn-danger btn-del " type="button"><i class="fa fa-times"></i></button>&nbsp;&nbsp;                              
                              <a href="<?php echo U('Admin/Fashion/save',array('id'=>$vo['id']));?>" class="btn btn-primary " type="button"><i class="fa fa-list"></i></a>
                            </td>
