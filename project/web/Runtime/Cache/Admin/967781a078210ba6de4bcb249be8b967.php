      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
               <div class="row">
                   <div class="col-lg-6">
                       <form role="form" action="<?php echo U('Admin/Goodscom/insert');?>" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                               <label>评论信息</label>
                               <textarea name="commsg" rows="3" placeholder="请输入评论信息" class="form-control"></textarea>
                           </div>

                           <div class="form-group">
                               <label>评论时间</label>
                               <input name="comtime" placeholder="请输入评论商品的时间" class="form-control">
                           </div>
